...
public class Exercise13 {
    ...
    public void printSpeed(int speed) {System.out.println("Speed:" + speed);
 }

    // Create method with same name, but with different parameters
    public String printSpeed(int speed, String carModel) {return "Speed:" +speed+ ", carModel:" + carModel;
    }
